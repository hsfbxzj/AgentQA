...
def test_deerflow_loads_both_agentqa_tools_from_config() -> None:
...
def test_agentqa_skill_declares_its_required_tools() -> None:
    ...
    assert {"agentqa_create_test_plan", "agentqa_execute_test_plan", "ask_clarification"} <= set(skill.allowed_tools)
